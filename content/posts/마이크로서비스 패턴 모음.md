...
## content
![Pasted image 20230607202957.png|]({{< ref "/posts/Pasted image 20230607202957.png|.md" >}})
- 패턴 개괄
	- 애플리케이션 패턴(application pattern): 개발자가 맞닥뜨리는 문제를 해결합니다.
		...
		- 데이터 일관성: 분산 db 간 일관성 유지하는 방법
			- ![Pasted image 20230607203948.png]({{< ref "/posts/Pasted image 20230607203948.png.md" >}})
	...
	- 애플리케이션 인프라(application infrastructure): 개발에도 영향을 미치는 인프라 문제를 해결합니다.
		- 통신: 
			- ![Pasted image 20230607203554.png]({{< ref "/posts/Pasted image 20230607203554.png.md" >}})
			- 통신(IPC) 스타일
			- 서비스 디스커버리
	...
	- 인프라 패턴(infrastructure pattern): 주로 개발 영역 밖의 인프라 문제를 해결합니다.
		- 배포
			- ![Pasted image 20230607204427.png]({{< ref "/posts/Pasted image 20230607204427.png.md" >}})




- Microservices Patterns - Conceptual Map
- ![Pasted image 20230607212748.png]({{< ref "/posts/Pasted image 20230607212748.png.md" >}})
