...
## content
{{< figure src="/images/Pasted image 20230607202957.png|" >}}
- 패턴 개괄
	- 애플리케이션 패턴(application pattern): 개발자가 맞닥뜨리는 문제를 해결합니다.
		...
		- 데이터 일관성: 분산 db 간 일관성 유지하는 방법
			- {{< figure src="/images/Pasted image 20230607203948.png" >}}
	...
	- 애플리케이션 인프라(application infrastructure): 개발에도 영향을 미치는 인프라 문제를 해결합니다.
		- 통신: 
			- {{< figure src="/images/Pasted image 20230607203554.png" >}}
			- 통신(IPC) 스타일
			- 서비스 디스커버리
	...
	- 인프라 패턴(infrastructure pattern): 주로 개발 영역 밖의 인프라 문제를 해결합니다.
		- 배포
			- {{< figure src="/images/Pasted image 20230607204427.png" >}}




- Microservices Patterns - Conceptual Map
- {{< figure src="/images/Pasted image 20230607212748.png" >}}
